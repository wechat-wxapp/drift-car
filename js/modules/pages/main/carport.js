    ...
    setTexture(data) {
        ...
        for(let i = 0;i < 3; i++){
            for(let j = 0;j < 3; j++) {
                ...
                carPane.src = 'https://wx.qlogo.cn/mmopen/vi_32/pcbt1wicwoepR0Kb8qoDedsn0QEZjgxOntxeSWAwdBUxaVon9MUpujv7nvupkg3mhMKibBgaljtciaA0QyZ8KzgKA/132';
                carPane.onload = () => {
        ...
        if (data.show) {
            ...
            switch(data.choose) {
                ...
                case 2:
                {
                    ...
                    this.cvs.drawImage(gift100, 0, 0, gift100.width, gift100.height, this.computedSizeW(325), this.computedSizeH(621), this.computedSizeW(238), this.computedSizeH(54));
                ...
                case 3:
                {
                    ...
                    this.cvs.drawImage(gift200, 0, 0, gift200.width, gift200.height, this.computedSizeW(325), this.computedSizeH(621), this.computedSizeW(238), this.computedSizeH(54));
                }
                    break;
                case 4:
                {
                    ...
                    this.cvs.drawImage(unlockGame, 0, 0, unlockGame.width, unlockGame.height, this.computedSizeW(325), this.computedSizeH(621), this.computedSizeW(238), this.computedSizeH(54));
                ...
                case 5:
                {
                    ...
                    this.cvs.drawImage(curve, 0, 0, curve.width, curve.height, this.computedSizeW(340), this.computedSizeH(621), this.computedSizeW(238), this.computedSizeH(54));
            ...
            if (data.success) {
                ...
                this.cvs.drawImage(unlockCn, 0, 0, unlockCn.width, unlockCn.height, this.computedSizeW(227), this.computedSizeH(518), this.computedSizeW(79), this.computedSizeH(43));
            }
        }
