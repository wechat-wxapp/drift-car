...
export default class wechatMP extends Init {
    ...
    setTexture(data) {
        ...
        this.cvs.drawImage(this.qrBtn, 0, 0, this.qrBtn.width, this.qrBtn.height, this.computedSizeW(238), this.relativeSizeH(976), this.computedSizeW(274), this.computedSizeW(83));
